...
export default function AdminRecruitmentPlacementsPage() {
      ...
      <main className="min-h-screen p-8 flex items-center justify-center">
        <Card className="bg-slate-900 border-slate-800 p-8 max-w-md text-center space-y-4">
          ...
          <p className="text-slate-400 text-sm">
            Your account ({role}) is not authorized to access placement records.
          </p>
        </Card>
      </main>
    );
  ...
  return (
    <main className="min-h-screen p-8 max-w-7xl mx-auto space-y-6 text-left">
      <div className="border-b border-slate-800 pb-6">
        ...
        <h1 className="text-3xl font-bold text-white tracking-tight mt-1">Master Placement Records</h1>
      </div>
