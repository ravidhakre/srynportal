...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${slug.replace(/-/g, " ")} | SRYN FinServ Blog`,
    description: "Financial awareness article from SRYN FinServ.",
  };
}
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 text-left">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-slate-500">By {post.authorName || "SRYN FinServ Team"}</p>
      </div>
